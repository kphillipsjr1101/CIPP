...
Adds or modifies an alert definition, including configuration and UI integration for tenant monitoring.
...
- Update src/pages/tenant/administration/alert-configuration/alert.jsx to reflect new or changed alert
