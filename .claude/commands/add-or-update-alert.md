...
Adds or updates an alert configuration for tenant monitoring.
...
- Edit src/data/alerts.json to add or update the alert entry.
- Update src/pages/tenant/administration/alert-configuration/alert.jsx to handle the new or updated alert in the UI.
